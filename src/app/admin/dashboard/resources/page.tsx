...
export default function AdminResourcesPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-8">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-[var(--color-text-primary)]">All Resources</h1>
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          placeholder="Search resources by title, platform, niche..."
        ...
        <table className="w-full text-left text-sm">
          <thead>
            <tr className="border-b border-[var(--color-border)] bg-[var(--color-bg-secondary)]">
              ...
              {(["title", "niche", "platform", "category", "level", "link"] as const).map((col) => (
                <th key={col} className="px-4 py-3">
                  ...
                  >
                    ...
                    {sortKey === col ? (
                      sortDir === "asc" ? (
                        <ArrowUp className="h-3.5 w-3.5 text-[var(--color-accent)]" />
                      ) : (
                        <ArrowDown className="h-3.5 w-3.5 text-[var(--color-accent)]" />
                      )
                    ) : (
                ...
                <td className="px-4 py-3">
                  <span
                    className={cn(
                      ...
                      LEVEL_COLORS[item.resource.lv as DifficultyLevel] || "bg-white/5 text-white/50"
                    )}
                  >
